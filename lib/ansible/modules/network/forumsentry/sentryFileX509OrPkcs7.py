...
def main():
  ...
  sentry_required_if = [
    [ 'state' , 'present' , [ 'name' , 'createSignerGroup' , 'certificateFile' ] ] ,
    [ 'state' , 'absent' , [ 'name' ] ]
  ]
  ...
  httpService_fileX509OrPkcs7 = '/restApi/v1.0/policies/keyPairs/import/fileX509OrPkcs7'

  formHeaderKeys = 'certificateFile'
 
  if module.params['state'] == 'present': 
    forum.importSentryObject( httpService_fileX509OrPkcs7 , formHeaderKeys )
  else:
